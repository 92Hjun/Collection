...
<style>
body {
	font-family: Helvetica33-ExtendedThin, '맑은 고딕', '돋움',sans-serif !important;
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a class="icon" href="#"><img alt="person"src="person.gif"></a></li>
				<li><a class="icon" href="cart.jsp"><img alt="cart" src="cart.gif"></a></li>
				<li class="dropdown">
					<a id="searchA" href="#" class="dropdown-toggle"data-toggle="dropdown" role="button" aria-expanded="false">
						<img alt="search" src="search.gif">
					</a>
					<ul id="dropUl" class="dropdown-menu" role="menu">
						<li>
