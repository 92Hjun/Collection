...
public class EmpApp {
	...
	public static void main(String[] args) throws Exception{
		...
		while (true) {
			...
			System.out.println("1.회원등록 2.가나다 이름순 3.경력순 0.종료");
			...
			if ("1".equals(menu)) {
				...
				Collections.sort(empList,(Emp e1, Emp e2) -> e1.getName().compareTo(e2.getName()));
				...
				System.out.println("경력순으로 파일을 저장하였습니다.");
					Collections.sort(empList, (Emp e1, Emp e2) -> e1.getCareer()- e2.getCareer());
